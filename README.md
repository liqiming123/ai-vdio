...
> 本项目是基于开源项目 MoneyPrinterTurbo 的二次开发版本，由 `liqiming123/ai-vdio` 维护和发布。
> 在保留原项目核心能力的基础上，本仓库用于中文化、功能扩展和后续定制开发。项目遵循仓库内的 MIT 许可证。

### 一站式 AI 短视频生成工具

只需提供视频<b>主题</b>或<b>关键词</b>，即可自动生成视频脚本、匹配素材、生成字幕和背景音乐，并合成高清短视频。

[![Version](https://img.shields.io/github/v/release/liqiming123/ai-vdio?color=blue&label=version)](https://github.com/liqiming123/ai-vdio/releases)
[![Platform](https://img.shields.io/badge/platform-Windows%20%7C%20macOS%20%7C%20Linux-lightgrey.svg)](https://github.com/liqiming123/ai-vdio/releases/latest)
[![Python](https://img.shields.io/badge/python-3.11%2B-3776AB?logo=python&logoColor=white)](https://www.python.org/)
[![Downloads](https://img.shields.io/github/downloads/liqiming123/ai-vdio/total)](https://github.com/liqiming123/ai-vdio/releases/latest)

<a href="https://trendshift.io/repositories/8731" target="_blank"><img src="https://trendshift.io/api/badge/repositories/8731" alt="liqiming123%2Fai-vdio | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
<a href="https://www.star-history.com/liqiming123/ai-vdio"><img src="https://api.star-history.com/badge?repo=liqiming123/ai-vdio" alt="Star History Rank" style="height: 55px;" height="55"/></a>

简体中文 | [English](README-en.md) | [日本語](README-ja.md) | [版本发布](https://github.com/liqiming123/ai-vdio/releases) | [问题反馈](https://github.com/liqiming123/ai-vdio/issues)
...
```text
使用这个 Skill：https://raw.githubusercontent.com/liqiming123/ai-vdio/main/docs/skill/SKILL.md
...
[![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/liqiming123/ai-vdio/blob/main/docs/MoneyPrinterTurbo.ipynb)

### Windows 一键启动包

下载一键启动包，解压直接使用（路径不要有 **中文**、**特殊字符**、**空格**）

- [下载最新 Windows 一键启动包](https://github.com/liqiming123/ai-vdio/releases/latest)
...
```shell
git clone https://github.com/liqiming123/ai-vdio.git
```
...
> 默认推荐使用 `docker-compose.release.yml`，它会直接拉取 GitHub Container Registry 上的预构建镜像：`ghcr.io/liqiming123/ai-vdio:latest`。
...
下载并解压后，将整个目录放到 `.\ai-vdio\models`，最终路径应为 `.\ai-vdio\models\whisper-large-v3`：
...
- 可以提交 [issue](https://github.com/liqiming123/ai-vdio/issues) 或者 [pull request](https://github.com/liqiming123/ai-vdio/pulls)。

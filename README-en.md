...
English | [简体中文](README.md) | [日本語](README-ja.md) | [Releases](https://github.com/liqiming123/ai-vdio/releases) | [Issues](https://github.com/liqiming123/ai-vdio/issues)
...
```text
Use this Skill: https://raw.githubusercontent.com/liqiming123/ai-vdio/main/docs/skill/SKILL.md
...
- [Download the latest Windows one-click package](https://github.com/liqiming123/ai-vdio/releases/latest)
...
> The recommended default is `docker-compose.release.yml`, which pulls the prebuilt image from GitHub Container Registry: `ghcr.io/liqiming123/ai-vdio:latest`.
...
- You can submit an [issue](https://github.com/liqiming123/ai-vdio/issues) or a [pull request](https://github.com/liqiming123/ai-vdio/pulls).
